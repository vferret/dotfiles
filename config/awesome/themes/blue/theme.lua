...
------------------------------------------------------------
theme.fonts = {
	main     = "M+ 1mn bold 14",      -- main font
	menu     = "M+ 1mn bold 12",      -- main menu font
	tooltip  = "M+ 1mn bold 12",      -- tooltip font
	notify   = "M+ 1mn bold 14",   -- redflat notify popup font
	clock    = "M+ 1mn bold 14",   -- textclock widget font
	qlaunch  = "M+ 1mn bold 14",   -- quick launch key label font
	keychain = "M+ 1mn bold 16",   -- key sequence tip font
	title    = "M+ 1mn bold 13", -- widget titles font
	titlebar = "M+ 1mn bold 13", -- client titlebar font
	hotkeys = {
		main  = "M+ 1mn 14",             -- hotkeys helper main font
		key   = "M+ 1mn Light 14", -- hotkeys helper key font (use monospace for align)
		title = "M+ 1mn bold 16",        -- hotkeys helper group title font
	},
}

theme.cairo_fonts = {
	tag         = { font = "M+ 1mn bold", size = 16, face = 1 }, -- tag widget font
	appswitcher = { font = "M+ 1mn", size = 20, face = 1 }, -- appswitcher widget font
	navigator   = {
		title = { font = "M+ 1mn", size = 28, face = 1, slant = 0 }, -- window navigation title font
		main  = { font = "M+ 1mn", size = 22, face = 1, slant = 0 }  -- window navigation  main font
	},
}
...
theme.icon.widget = {
	...
	wireless = theme.path .. "/widget/net.svg",
...
theme.gauge.tag.blue = {
	...
	point    = { width = 50, height = 3, gap = 27, dx = 5 },
	text_gap = 20,
	color    = theme.color
}
...
theme.widget.tasklist.winmenu = {
	...
	menu           = { width = 170, color = { right_icon = theme.color.icon }, ricon_margin = { 9, 9, 9, 9 } },
